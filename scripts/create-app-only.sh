...
usage() {
  cat <<'EOF'
Usage:
  create-app-only.sh <vmid> <name> [--template-id <id>] [--snippets-storage-id <id>] [options]
  create-app-only.sh --vmid <id> --name <name> --template-id <id> --snippets-storage-id <id> [options]
