...
usage() {
  cat <<'EOF'
Usage:
  create-edgeapp.sh <vmid> <name> [--template-id <id>] [--snippets-storage-id <id>] [options]
  create-edgeapp.sh --vmid <id> --name <name> --template-id <id> --snippets-storage-id <id> [options]
